...
# def resnet18(bn_momentum=0.1, pretrained=False, output_stride=16):
#     """Constructs a ResNet-18 model.

#     Args:
#         pretrained (bool): If True, returns a model pre-trained on ImageNet
#     """
#     model = ResNet(Bottleneck, [2, 2, 2, 2], bn_momentum, pretrained, output_stride)
#     if pretrained:
#         model = load_pretrained_model(model, 'resnet18')
#     return model


# def resnet34(bn_momentum=0.1, pretrained=False, output_stride=16):
...
#     if pretrained:
#         model = load_pretrained_model(model, 'resnet34')
#     return model
